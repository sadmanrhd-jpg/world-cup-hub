...
const navItems = [
  ...
  { to: "/fantasy", label: "Fantasy", icon: Trophy, featured: true },
              ...
              {navItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) => {
                    ...
                    return `whitespace-nowrap rounded-full border px-2.5 py-2 text-xs font-semibold transition-all xl:px-3 xl:text-sm ${
                      isActive
                        ? featured
                          ? "border-[#FAC938] bg-[#FAC938] text-black shadow-[0_0_18px_rgba(250,201,56,.32)]"
                          : "border-primary bg-primary text-primary-foreground glow"
                        : featured
                          ? "border-[#FAC938]/55 bg-[#FAC938]/12 text-[#FAC938] shadow-[0_0_14px_rgba(250,201,56,.16)] hover:bg-[#FAC938] hover:text-black"
            ...
            >
              ...
              <div className="space-y-1.5">
                {mobileActionItems.map((item) => {
                  ...
                  const featured = item.to === "/fantasy";
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 rounded-xl border px-4 py-3.5 text-sm font-semibold transition-all ${
                          isActive
                            ? featured
                              ? "border-[#FAC938] bg-[#FAC938] text-black shadow-lg"
                              : "border-primary bg-primary text-primary-foreground shadow-lg"
                            : featured
                              ? "border-[#FAC938]/55 bg-[#FAC938]/12 text-[#FAC938] shadow-[0_0_16px_rgba(250,201,56,.16)]"
