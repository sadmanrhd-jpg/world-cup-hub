...
const modeFromParams = (value: string | null): Mode =>
  ...
  return (
    <div
      className={
        compact
          ? ""
          : "rounded-3xl border border-border p-5 card-elevated sm:p-7"
      }
    >
      ...
      <p className="mt-2 text-center text-[11px] leading-relaxed text-muted-foreground">
        Guest access starts with {GUEST_INITIAL_DAYS} days and can be extended.
        Data stays tied to this browser.
      </p>
    </div>
  );
};
